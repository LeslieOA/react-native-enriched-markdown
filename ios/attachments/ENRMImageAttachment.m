                     ...
                     borderRadius:(CGFloat)radius
{
  ...
  [image drawInRect:drawingRect fromRect:NSZeroRect operation:NSCompositingOperationSourceOver fraction:1.0];
...
#if TARGET_OS_OSX
  NSImage *placeholder = [[NSImage alloc] initWithSize:CGSizeMake(1, 1)];
